...
*/
  ...
  when 'Pick_Summary' then
    select "t"."c_work_place",
      ...
      --order by c_work_place asc,st_store_stage_grp_mst.c_name asc,c_user asc 
      --group by "c_work_place","st_daywise_emp_performance"."c_user","st_store_stage_grp_mst"."c_name"
      from(select "c_work_place",
          "st_store_stage_grp_mst"."c_name" as "c_name",
          "st_daywise_emp_performance"."c_user",
          "n_avg_time_in_seconds" as "time_in_sec",
          "n_item_pick_count" as "item_pick_count",
          "n_bounce_count" as "item_bounce_count"
          from "st_daywise_emp_performance"
            left outer join "st_store_stage_grp_mst" on "st_store_stage_grp_mst"."c_code" = "st_daywise_emp_performance"."c_stage_grp_code"
          where "d_date" >= "uf_default_date"()
          and "c_work_place" <> 'BARCODE PRINT'
          and "item_pick_count" > 0 union
      ...
      from(select "tem"."c_work_place",
          ...
          from(select "c_work_place",
              ...
              from "st_daywise_emp_performance"
                left outer join "st_store_stage_grp_mst" on "st_store_stage_grp_mst"."c_code"
                 = "st_daywise_emp_performance"."c_stage_grp_code"
              where "d_date" = "uf_default_date"()-1
              and "c_work_place" <> 'BARCODE PRINT') as "Tem"
        ...
        select "tem"."c_work_place",
          ...
          from(select "c_work_place",
              ...
              from "st_daywise_emp_performance"
                left outer join "st_store_stage_grp_mst" on "st_store_stage_grp_mst"."c_code" = "st_daywise_emp_performance"."c_stage_grp_code"
              where "d_date" = "uf_default_date"()-7
              and "c_work_place" <> 'BARCODE PRINT') as "Tem"
        ...
        select "tem"."c_work_place",
          ...
          from(select 'Inward as Purchase' as "c_work_place",
              ...
              group by "c_work_place","pur_mst"."c_user","stagename") as "Tem"
          group by "tem"."c_work_place","tem"."stagename" union all
        select "tem"."c_work_place",
          "tem"."stagename",
          0 as "prev_day_time_in_sec",
        ...
        select "tem"."c_work_place",
          ...
          from(select 'Inward as GRE' as "c_work_place",
              ...
              group by "c_work_place","goods_rec_det"."c_user","stagename") as "Tem"
          group by "tem"."c_work_place","tem"."stagename" union all
        select "tem"."c_work_place",
          "tem"."stagename",
          0 as "prev_day_time_in_sec",
