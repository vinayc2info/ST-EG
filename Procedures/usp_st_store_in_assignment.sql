...
*/
  ...
  when 'item_search' then
    ...
    select "c_doc_no","trans"."c_bill_no","c_batch_no","n_qty"/@qpb as "n_qty",
      ...
      "trans"."c_supp_code"
      from "st_Track_in"
        join(select "c_br_code","c_year","c_prefix","n_srno","c_bill_no","c_supp_code" as "c_supp_code" from "pur_mst" where "n_post" = 1 union
        select "c_br_code","c_year","c_prefix","n_srno","string"("n_ref_srno"),"c_ref_br_code" as "c_supp_code" from "grn_mst" where "n_post" = 1 union
        select "c_br_code","c_year","c_prefix","n_srno","c_ref_no","c_cust_code" as "c_supp_code" from "crnt_mst") as "trans"
        --"trans"."c_br_code"+'/'+"trans"."c_year"+'/'+"trans"."c_prefix"+'/'+"string"("trans"."n_srno") = "st_track_in"."c_doc_no"
  ...
  when 'doc_list' then
    ...
    select "c_doc_no",
      ...
      "prefix_srno"."c_trans" as "c_trans",
      ...
      from "st_track_in"
        left outer join "pur_mst" --"pur_mst"."c_br_code"+'/'+"pur_mst"."c_year"+'/'+"pur_mst"."c_prefix"+'/'+"string"("pur_mst"."n_srno") = "st_track_in"."c_doc_no" 
        on "pur_mst"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
        ...
        left outer join "grn_mst" --"grn_mst"."c_br_code"+'/'+"grn_mst"."c_year"+'/'+"grn_mst"."c_prefix"+'/'+"string"("grn_mst"."n_srno") = "st_track_in"."c_doc_no" 
        on "grn_mst"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
        ...
        left outer join "crnt_mst" --"crnt_mst"."c_br_code"+'/'+"crnt_mst"."c_year"+'/'+"crnt_mst"."c_prefix"+'/'+"string"("crnt_mst"."n_srno") = "st_track_in"."c_doc_no"
        on "crnt_mst"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
        ...
        left outer join "godown_tran_mst" --"godown_tran_mst"."c_br_code"+'/'+"godown_tran_mst"."c_year"+'/'+"godown_tran_mst"."c_prefix"+'/'+"string"("godown_tran_mst"."n_srno") = "st_track_in"."c_doc_no" 
        on "godown_tran_mst"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
        ...
        left outer join "dbnt_mst" --"dbnt_mst"."c_br_code"+'/'+"dbnt_mst"."c_year"+'/'+"dbnt_mst"."c_prefix"+'/'+"string"("dbnt_mst"."n_srno") = "st_track_in"."c_doc_no" 
        on "dbnt_mst"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
        ...
        left outer join "prefix_srno" --"prefix_srno"."c_br_code"+'/'+"prefix_srno"."c_year"+'/'+"prefix_srno"."c_prefix" = "left"("st_track_in"."c_doc_no",8)
        on "prefix_srno"."c_br_code" = "left"(("st_track_in"."c_doc_no"),"charindex"('/',("st_track_in"."c_doc_no"))-1)
  ...
  when 'get_items' then
    ...
    select "c_doc_no" as "c_doc_no",
      ...
      (select "list"(distinct "item_bin_info"."c_tray_code")+'-'+"list"(distinct "item_bin_info"."n_carton_no")+'-'+"list"(distinct "item_bin_info"."c_bin_code")
        from "item_bin_info"
  ...
  when 'Get_bin_info' then
    ...
    select "n_gate_pass_no" into @n_gate_pass_no from "Pur_mst"
      where "pur_mst"."c_br_code"+'/'+"pur_mst"."c_year"+'/'+"pur_mst"."c_prefix"+'/'+"string"("pur_mst"."n_srno") = @HdrData;
  ...
  when 'Item_click' then
    ...
    if sqlstate = '00000' then
      commit work;
      insert into "st_inward_track"( "c_br_code","c_year","c_prefix","n_srno","n_seq","d_store_in_date","c_store_in_user","c_doc_no","c_tray_code" ) on existing update defaults off
        select "left"(("c_doc_seq_no"),"charindex"('/',("c_doc_seq_no"))-1) as "c_br_code",
          "left"("substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1),"charindex"('/',"substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1))-1) as "c_year",
          "left"("substr"("substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1),"charindex"('/',"substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1))+1),"charindex"('/',"substr"("substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1),"charindex"('/',"substring"("left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))),"charindex"('/',"left"("c_doc_seq_no",("length"("c_doc_seq_no")-("charindex"('/',"reverse"("c_doc_seq_no"))-1))))+1))+1))-1) as "c_prefix",
          "reverse"("left"("substring"("left"("reverse"("c_doc_seq_no"),("length"("reverse"("c_doc_seq_no"))-("charindex"('/',"reverse"("reverse"("c_doc_seq_no")))-1))),"charindex"('/',"left"("reverse"("c_doc_seq_no"),("length"("reverse"("c_doc_seq_no"))-("charindex"('/',"reverse"("reverse"("c_doc_seq_no")))-1))))+1),"charindex"('/',"substring"("left"("reverse"("c_doc_seq_no"),("length"("reverse"("c_doc_seq_no"))-("charindex"('/',"reverse"("reverse"("c_doc_seq_no")))-1))),"charindex"('/',"left"("reverse"("c_doc_seq_no"),("length"("reverse"("c_doc_seq_no"))-("charindex"('/',"reverse"("reverse"("c_doc_seq_no")))-1))))+1))-1)) as "n_srno",
          "reverse"("left"("reverse"("c_doc_seq_no"),"charindex"('/',("reverse"("c_doc_seq_no")))-1)) as "n_seq",
          "now"(),@UserId,"c_doc_seq_no",@TrayCode
          from "doc_seq_list";
    ...
    select "list"("tem"."c_item_code"+'-'+"tem"."c_godown_code")
      ...
      from(select "st_track_in"."c_item_code","st_track_in"."c_godown_code",
          if "st_track_in"."c_godown_code" = '-' then
            (select "c_rack" into "c_rak" from "item_mst_br_info" where "item_mst_br_info"."c_br_code" = "left"("st_track_in"."c_doc_no",3)
              and "item_mst_br_info"."c_code" = "st_track_in"."c_item_code" and "item_mst_br_info"."c_br_code" = @BrCode)
          else
            (select "c_rack" into "c_rak" from "item_mst_br_info_godown" where "item_mst_br_info_godown"."c_br_code" = "left"("st_track_in"."c_doc_no",3)
              and "item_mst_br_info_godown"."c_code" = "st_track_in"."c_item_code"
      ...
      if @s_exp_godown_code = @GodownCode then --exp doc , no need to validate rack grp 
        ...
        if
          (select "count"()
           ...
           = 0 then
          /*commented since while assign Tray ,will not knw the godown code 
select 'Selected tray Contains Items of stage : '+max(st_store_stage_det.c_rack_grp_code) as c_message
from st_track_in
join st_store_stage_det on st_track_in.c_rack_grp_code = st_store_stage_det.c_rack_grp_code
where c_tray_code = @TrayCode for xml raw,elements;
return ;
*/
        end if end if end if;
