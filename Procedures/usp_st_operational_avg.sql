...
begin
  ...
  declare "YA" numeric(14,8);
  declare "WA" numeric(14,8);
  ...
  when 'get_avg_week_yest' then
    ...
    select "avg"("Tot_avg_time_yestr") as "Ys_Avg"
      ...
      from(select distinct "c_user" as "c_usr",
          ...
          from(select "st_daywise_emp_performance"."c_user" as "c_user",
              "sum"("st_daywise_emp_performance"."n_avg_time_in_seconds") as "Tot_avg_time_yestr",
            ...
            select "st_daywise_emp_performance"."c_user" as "c_user",
              "sum"("st_daywise_emp_performance"."n_avg_time_in_seconds") as "Tot_avg_time_yestr",
              "sum"("st_daywise_emp_performance"."n_item_count") as "yday_pick_count",
              0 as "Lw_avg",
              0 as "Lw_pick_count"
              from "st_daywise_emp_performance"
              where "d_date" = @dt_prev_working_date
